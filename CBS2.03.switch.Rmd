---
title: "SiT - Mouse Coronal Brain Section (CBS2) - 03.switch"
...
write.table(totaladj, file="output/CBS2.isoswitch.top.csv", sep=",")
...
write.table(total, file="output/CBS2.isoswitch.csv", sep=",")
...
length(unique(totaladj$geneId))
print(unique(totaladj$geneId))
write.table(totaladj, file="output/CBS2.juncswitch.top.csv", sep=",")
...
length(unique(total$geneId))
print(unique(total$geneId))
write.table(total, file="output/CBS2.juncswitch.csv", sep=",")
