---
title: "SiT - Supplementary Figure 13"
...
pdf("figures/Figure.sup.13.caly.pdf", width=10, height=6, useDingbats=FALSE)
plot_grid(p1,p2)
...
pdf("figures/Figure.sup.13.cnih2.pdf", width=10, height=6, useDingbats=FALSE)
plot_grid(p1,p2)
ggplot(df, aes(x=region, y=value, fill=variable)) +
    geom_bar(stat='identity', position='dodge') +
    theme_minimal() +
...
pdf("figures/Figure.sup.13.dtnbp1.pdf", width=10, height=6, useDingbats=FALSE)
plot_grid(p1,p2)
ggplot(df, aes(x=region, y=value, fill=variable)) +
    geom_bar(stat='identity', position='dodge') +
    theme_minimal() +
...
pdf("figures/Figure.sup.13.aldoa.pdf", width=10, height=6, useDingbats=FALSE)
plot_grid(p1,p2)
ggplot(df, aes(x=region, y=value, fill=variable)) +
    geom_bar(stat='identity', position='dodge') +
    theme_minimal() +
