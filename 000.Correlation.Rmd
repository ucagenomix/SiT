...
ggplot(data=visium@meta.data, aes(x=nFeature_Spatial,y=nFeature_ISOG)) +  geom_point(shape = 21, colour = col[visium@active.ident], fill = col[visium@active.ident]) +
...
ggplot(data=visium@meta.data, aes(x=nCount_Spatial,y=nCount_ISOG)) +  geom_point(shape = 21, colour = col[visium@active.ident], fill = col[visium@active.ident]) +
      theme_bw() + theme(panel.grid.minor=element_blank(), panel.grid.major=element_blank()) +
