---
title: "Visium Spatial Tx - Mouse Hippocampus (hip142079) - 03.isoforms"
...
for (i in (1:11)){
  ...
  for (j in (k:12)){
    if(i != j){
      ...
      markers <- FindMarkers(object = hip142079, ident.1=clusters[i], ident.2=clusters[j])
      ...
      print (dim(totaladj))
      print (length(unique(totaladj$geneId)))
    }
  }
}
...
write.table(totaladj, file="output/hip142079.isoswitch.top.csv", sep=",")
...
write.table(total, file="output/hip142079.isoswitch.csv", sep=",")
...
DefaultAssay(object = hip142079) <- "JUNC"
total <- data.frame()
totaladj <- data.frame()
for (i in (1:11)){
  k <- i+1
...
length(unique(totaladj$geneId))
print(unique(totaladj$geneId))
write.table(totaladj, file="output/hip142079.juncswitch.top.csv", sep=",")
...
length(unique(total$geneId))
print(unique(total$geneId))
write.table(total, file="output/hip142079.juncswitch.csv", sep=",")
