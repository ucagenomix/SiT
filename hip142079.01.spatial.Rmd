...
SpatialFeaturePlot(hip142079, features = c("nCount_Spatial","nFeature_Spatial"), max.cutoff = 30000, pt.size.factor = 2) + 
  theme(legend.position = "right") + 
  ggtitle("hip142079 nCount_Spatial")
...
new.cluster.ids <- c("Midbrain","Hippocampus","Isocortex-1","Isocortex-1","Olfactory area","Fiber tracts","Hammons horn","Isocortex-2","Hippocampus","Hypothalamus","Thalamus","Dg","Isocortex-3","Ca3")
names(x = new.cluster.ids) <- levels(x = hip142079)
hip142079 <- RenameIdents(object = hip142079, new.cluster.ids)

my_levels <- c("Midbrain","Hippocampus","Isocortex-1","Isocortex-2","Olfactory area","Fiber tracts","Isocortex-3","Hammons horn","Thalamus","Hypothalamus","Ca3","Dg")
