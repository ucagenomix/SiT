...
# Integration of external data (stxBrain from SeuratData)
...
saveRDS(object = cluster_markers_all, file = here::here("markers_allen.rds"))
...
saveRDS(object = spotlight_ls, file = here::here("spotlight_allen_CBS2.rds"))
...
Seurat::SpatialFeaturePlot(
  object = CBS2,
  features = c("L2.3.IT","L4","L5.IT","L5.PT","L6.CT","L6.IT", "L6b"),
  alpha = c(0.1, 1))
...
saveRDS(CBS2, "./output/CBS2.nanopore.allen.rds")
...
#For SiTx
#saveRDS(CBS2, "./output/CBS2.nanopore.deconv.rds")
...
#pdf("spotlight.CBS2.pdf", width=16, height=12, useDingbats=FALSE)
SPOTlight::spatial_scatterpie(se_obj = CBS2,
                              cell_types_all = cell_types_all,
                              img_path = "/data/10x_data/10x_visium/illumina/CBS2/spatial/tissue_lowres_image.png",
                              pie_scale = 0.4)
...
#pdf("spotlight.CBS2.alltype.pdf", width=32, height=8, useDingbats=FALSE)
Seurat::SpatialFeaturePlot(
  object = CBS2,
  features = int,
  alpha = c(0.1, 1))
