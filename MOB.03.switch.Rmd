---
title: "SiT - Mouse Olfactory Bulb (MOB) - 03.switch"
...
write.table(totaladj, file="output/MOB.isoswitch.top.csv", sep=",")
...
write.table(total, file="output/MOB.isoswitch.csv", sep=",")
...
length(unique(totaladj$geneId))
print(unique(totaladj$geneId))
write.table(totaladj, file="output/MOB.juncswitch.top.csv", sep=",")
...
length(unique(total$geneId))
print(unique(total$geneId))
write.table(total, file="output/MOB.juncswitch.csv", sep=",")
