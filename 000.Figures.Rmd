...
#i <- subset(hip142079, ident=c("CA1/CA2"))
#SpatialDimPlot(i)
...
#top.features <- head(SpatiallyVariableFeatures(hip142079, selection.method = "markvariogram"), 60)
#DotPlot(hip142079, features=top.features) + RotatedAxis()
...
DefaultAssay(object = hip142079) <- "SCT"
SpatialFeaturePlot(hip142079, features = c("Mbp"), pt.size.factor=1.6, alpha = c(1, 1))
...
table(Matrix::rowSums(hip142079@assays$AtoI@data)>0)
...
hip142078 <- subset(hip142078, ident=c("Midbrain","Hippocampus area","Isocortex-1","Isocortex-2","Olfactory area","Fiber tracts","Retrosplenial area","CA1/CA2","Thalamus","Hypothalamus","CA3","DG"))
hip142079 <- subset(hip142079, ident=c("Midbrain","Hippocampus area","Isocortex-1","Isocortex-2","Olfactory area","Fiber tracts","Retrosplenial area","CA1/CA2","Thalamus","Hypothalamus","CA3","DG"))
