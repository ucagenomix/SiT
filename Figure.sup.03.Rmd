...
pdf("figures/Figure.sup.03.MOB.pdf", width=10, height=8, useDingbats=FALSE)
...
pdf("figures/Figure.sup.03.CBS1.pdf", width=10, height=8, useDingbats=FALSE)
plot_grid(p1, p2, ncol=1)
dev.off()
...
pdf("figures/Figure.sup.03.CBS2.pdf", width=10, height=8, useDingbats=FALSE)
plot_grid(p1, p2, ncol=1)
dev.off()
