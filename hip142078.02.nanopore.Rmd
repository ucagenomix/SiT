...
clusters <- c("Midbrain","Hippocampus","Isocortex-1","Isocortex-2","Olfactory area","Fiber tracts","Ca1sp","Hypothalamus","Thalamus","DG-sg","RSP subiculum","Ca3sp","Outside")
...
all = read.delim("./nanopore/hip142078.snp100838.RN3.QV6_snpmatrix.csv", sep=",", stringsAsFactors = F)
data = all[,4:ncol(all)]
dim(data)
colnames(data) <- paste(colnames(data),"-1", sep="")
rownames(data) = paste(all$geneId, all$transcriptId, sep=":")
