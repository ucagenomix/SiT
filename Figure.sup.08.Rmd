...
pdf("figures/Figure.sup.08de.pdf", width=8, height=6, useDingbats=FALSE)
...
pdf("figures/Figure.sup.08f.pdf", width=8, height=6, useDingbats=FALSE)
pheatmap(ct, annotation_col=df, cluster_rows=TRUE, cluster_cols=TRUE, fontsize = 8, clustering_method = "complete")
dev.off()
